...
import com.yatmk.app.common.utility.FileUtility;
import com.yatmk.app.common.utility.RangeUtil;
import com.yatmk.app.infrastructure.config.UploadFolder;
import com.yatmk.app.persistence.constants.Constants;
import com.yatmk.app.persistence.constants.FileExtension;
import com.yatmk.app.persistence.exception.config.ServerSideException;
import com.yatmk.app.persistence.exception.file.FileNotFoundException;
import com.yatmk.app.persistence.exception.file.FileUnStreamableException;
import com.yatmk.app.persistence.models.local.Attachement;
import com.yatmk.app.persistence.presentation.ApiDownloadInput;
import com.yatmk.app.persistence.presentation.ApiDownloadInputLarge;
import com.yatmk.app.persistence.presentation.ApiPartialInput;
import com.yatmk.app.persistence.repositories.local.AttachementRepository;
...
public class AttachementService {
  ...
  public Optional<Attachement> getById(@Valid @NotNull Long attachmentId) {
    return attachementRepository.findById(attachmentId);
  }

  public ApiDownloadInput downloadFile(@Valid @NotNull Long attachmentId) {
  ...
  public ApiDownloadInputLarge downloadAttachementLarge(@Valid @NotNull Long attachmentId) {
    log.info("download attachment with id : {}", attachmentId);
    return Optional.of(attachmentId)
        .map(attachementRepository::findById)
        .flatMap(Function.identity())
  ...
  public void deleteAttachement(@Valid @NotNull Long attachmentId) {
  ...
  public ApiPartialInput streamFile(@Valid @NotNull Long fileId, String httpRangeList) {
